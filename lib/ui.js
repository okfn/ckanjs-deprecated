...
CKAN.UI = function($) {
  ...
  my.Workspace = Backbone.Router.extend({
    ...
    initialize: function(options) {
      ...
      var newCreateView = new CKAN.View.DatasetCreateView({model: newPkg, el: $('#dataset-add-page')});
